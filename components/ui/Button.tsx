...
interface ButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  ...
  // Added size property to fix TS error in Dashboard.tsx (lines 1223, 1232)
  size?: 'sm' | 'md' | 'lg';
  isLoading?: boolean;
}
...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  // Removed hardcoded padding from baseStyle to allow size variations via the sizes object
  ...
  // Defined size variations; 'md' matches the original hardcoded padding
  const sizes = {
